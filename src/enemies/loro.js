export default class Loro extends Phaser.GameObjects.PathFollower {
    ...
    constructor(scene, path, x = 0, y = 0, speed = 15, damage = 10, vida = 100, type, moneyDrop, loroname, texture = "loro", frame = 0) {
        ...
        this.audiosHit.push(
            ...
            this.scene.sound.add('lorohit3', { volume: 0.8 }),
            this.scene.sound.add('lorohit4', { volume: 0.8 }));


        // Audio de daño crítico 
        this.audiosCrit.push(
            this.scene.sound.add('lorocritic', { volume: 0.8 }),
            this.scene.sound.add('lorocritic2', { volume: 0.8 }));
